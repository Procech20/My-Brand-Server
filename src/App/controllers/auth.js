...
class Auth {
  ...
  static async register(req, res, next) {
    try {
      ...
      return successRes(res, 201, 'Successfully Registered a user', {...req.body});
    } catch (err) {
  ...
  static async logged(req, res, next) {
    try {
      ...
      return next(new ErrorResponse(res,400,'Error getting user! Please provide sign in or check the provided credentials!'));
    }
  }
  // @desc     User login
